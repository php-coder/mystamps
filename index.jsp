...
<ul>
	<li><a href="${registerUserUrl}"><fmt:message key="t_register_on_site" /></a></li>
	<li><a href="${authUserUrl}"><fmt:message key="t_auth_on_site" /></a></li>
	<li><a href="${restorePasswordUrl}"><fmt:message key="t_recover_forget_password" /></a></li>
	<li><a href="${addStampsUrl}"><fmt:message key="t_add_series" /></a></li>
</ul>
</div>
