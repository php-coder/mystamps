...
--
    ...
    create table series (
        id integer not null auto_increment,
        comment varchar(255),
        gibbons_currency varchar(3),
        gibbons_price double precision,
        image_url varchar(255),
        created_at datetime not null,
        updated_at datetime not null,
        michel_currency varchar(3),
        michel_price double precision,
        perforated bit not null,
        quantity integer not null,
        released_at date,
        scott_currency varchar(3),
        scott_price double precision,
        yvert_currency varchar(3),
        yvert_price double precision,
        country_id integer,
        created_by integer not null,
        updated_by integer not null,
        primary key (id)
