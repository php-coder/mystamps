...
public class UniqueMichelNumbersValidator
	implements ConstraintValidator<UniqueMichelNumbers, String> {
	
	@Inject
	private SeriesService seriesService;
	
	@Override
	public void initialize(UniqueMichelNumbers annotation) {
