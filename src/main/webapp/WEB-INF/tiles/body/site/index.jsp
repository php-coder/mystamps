...
<spring:url var="addCategoryUrl" value="<%= Url.ADD_CATEGORY_PAGE %>" />
<spring:url var="addCountryUrl" value="<%= Url.ADD_COUNTRY_PAGE %>" />

<div class="span10">
	<sec:authorize access="hasAnyAuthority('CREATE_CATEGORY', 'CREATE_COUNTRY', 'CREATE_SERIES')">
		...
		<nav>
			<ul>
				...
				<sec:authorize access="hasAuthority('CREATE_CATEGORY')">
					<li><a href="${addCategoryUrl}"><spring:message code="t_create_category" /></a></li>
				</sec:authorize>
...
<div class="span2">
	...
	<p>
		<spring:message code="t_categories_amount" />: ${categoryCounter}
	</p>
	<p>
