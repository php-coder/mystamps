...
import ru.mystamps.web.test.page.AbstractPage;
import ru.mystamps.web.test.page.AddSeriesPage;
import ru.mystamps.web.test.page.InfoSeriesPage;
import ru.mystamps.web.Url;

import static ru.mystamps.web.test.fest.PageWithFormAssert.assertThat;
